...
export const VAXT_DATABAS = {
  tomat: { visningsnamn: "Tomat", vatten: "hog", sol: "sol", avstand_cm: 50,
    sasong: "Så inomhus mars–april, plantera ut efter frostrisk (juni), skörda aug–sep",
    sasong_en: "Sow indoors March–April, transplant after frost risk (June), harvest Aug–Sep", svarighet: "medel" },
  potatis: { visningsnamn: "Potatis", vatten: "medel", sol: "sol", avstand_cm: 30,
    sasong: "Sätt april–maj, skörda jul–sep", sasong_en: "Plant April–May, harvest Jul–Sep", svarighet: "latt" },
  paprika: { visningsnamn: "Paprika/chili", vatten: "hog", sol: "sol", avstand_cm: 40,
    sasong: "Så inomhus feb–mars, plantera ut i juni, skörda aug–okt",
    sasong_en: "Sow indoors Feb–March, transplant in June, harvest Aug–Oct", svarighet: "svar" },
  aubergine: { visningsnamn: "Aubergine", vatten: "hog", sol: "sol", avstand_cm: 45,
    sasong: "Så inomhus feb–mars, plantera ut i juni (helst växthus), skörda aug–sep",
    sasong_en: "Sow indoors Feb–March, transplant in June (greenhouse preferred), harvest Aug–Sep", svarighet: "svar" },
  gurka: { visningsnamn: "Gurka", vatten: "hog", sol: "sol", avstand_cm: 40,
    sasong: "Så inomhus april, plantera ut eller så direkt i juni, skörda jul–sep",
    sasong_en: "Sow indoors in April, or transplant/direct-sow in June, harvest Jul–Sep", svarighet: "medel" },
  zucchini: { visningsnamn: "Zucchini/squash", vatten: "hog", sol: "sol", avstand_cm: 80,
    sasong: "Så inomhus april–maj eller direkt i juni, skörda jul–sep",
    sasong_en: "Sow indoors April–May or direct-sow in June, harvest Jul–Sep", svarighet: "latt" },
  pumpa: { visningsnamn: "Pumpa", vatten: "hog", sol: "sol", avstand_cm: 100,
    sasong: "Så inomhus april–maj, plantera ut i juni, skörda sep–okt",
    sasong_en: "Sow indoors April–May, transplant in June, harvest Sep–Oct", svarighet: "medel" },
  art: { visningsnamn: "Ärt", vatten: "medel", sol: "sol", avstand_cm: 10,
    sasong: "Så direkt april–maj, skörda jun–aug", sasong_en: "Direct-sow April–May, harvest Jun–Aug", svarighet: "latt" },
  bona: { visningsnamn: "Böna", vatten: "medel", sol: "sol", avstand_cm: 15,
    sasong: "Så direkt efter frostrisk (juni), skörda jul–sep",
    sasong_en: "Direct-sow after frost risk (June), harvest Jul–Sep", svarighet: "latt" },
  morot: { visningsnamn: "Morot", vatten: "medel", sol: "sol", avstand_cm: 5,
    sasong: "Så direkt april–juni, skörda jul–okt", sasong_en: "Direct-sow April–June, harvest Jul–Oct", svarighet: "latt" },
  radisa: { visningsnamn: "Rädisa", vatten: "medel", sol: "sol", avstand_cm: 4,
    sasong: "Så direkt från april, klar på 3–4 veckor - så om flera gånger",
    sasong_en: "Direct-sow from April, ready in 3–4 weeks - sow again several times", svarighet: "latt", saddIntervallDagar: 10 },
  ...
  purjolok: { visningsnamn: "Purjolök", vatten: "medel", sol: "sol", avstand_cm: 15,
    sasong: "Så inomhus mars, plantera ut i juni, skörda sep–nov",
    sasong_en: "Sow indoors in March, transplant in June, harvest Sep–Nov", svarighet: "medel" },
  vitlok: { visningsnamn: "Vitlök", vatten: "lag", sol: "sol", avstand_cm: 10,
    sasong: "Sätt i oktober för övervintring, eller tidigt på våren, skörda jul–aug",
    sasong_en: "Plant in October to overwinter, or early spring, harvest Jul–Aug", svarighet: "latt" },
  lok: { visningsnamn: "Lök", vatten: "lag", sol: "sol", avstand_cm: 10,
    sasong: "Sätt sättlök april–maj, skörda aug–sep", sasong_en: "Plant onion sets April–May, harvest Aug–Sep", svarighet: "latt" },
  kal: { visningsnamn: "Kål", vatten: "hog", sol: "sol", avstand_cm: 50,
    sasong: "Så inomhus mars–april, plantera ut i maj–juni, skörda aug–okt",
    sasong_en: "Sow indoors March–April, transplant in May–June, harvest Aug–Oct", svarighet: "medel" },
  sallad: { visningsnamn: "Sallad", vatten: "hog", sol: "halvskugga", avstand_cm: 25,
    sasong: "Så direkt eller inomhus från april, klar 6–8 veckor senare - så om flera gånger",
    sasong_en: "Direct-sow or start indoors from April, ready 6–8 weeks later - sow again several times", svarighet: "latt", saddIntervallDagar: 14 },
  spenat: { visningsnamn: "Spenat", vatten: "medel", sol: "halvskugga", avstand_cm: 10,
    sasong: "Så direkt mars–april och igen aug–sep, klar 4–6 veckor senare",
    sasong_en: "Direct-sow March–April and again Aug–Sep, ready 4–6 weeks later", svarighet: "latt" },
  dill: { visningsnamn: "Dill", vatten: "medel", sol: "sol", avstand_cm: 15,
    sasong: "Så direkt från april, så om varannan vecka för jämn skörd",
    sasong_en: "Direct-sow from April, sow again every other week for a steady harvest", svarighet: "latt", saddIntervallDagar: 14 },
  basilika: { visningsnamn: "Basilika", vatten: "medel", sol: "sol", avstand_cm: 20,
    sasong: "Så inomhus april, ställ ut efter frostrisk i juni - känslig för kyla",
    sasong_en: "Sow indoors in April, move outside after frost risk in June - sensitive to cold", svarighet: "medel" },
  jordgubbe: { visningsnamn: "Jordgubbe", vatten: "medel", sol: "sol", avstand_cm: 30,
    sasong: "Plantera vår eller höst, full skörd andra året, skörda jun–jul",
    sasong_en: "Plant spring or autumn, full harvest the second year, harvest Jun–Jul", svarighet: "latt" },
  persilja: { visningsnamn: "Persilja", vatten: "medel", sol: "halvskugga", avstand_cm: 15,
    sasong: "Så direkt eller inomhus från april - långsam att gro, skörda kontinuerligt jun–okt",
    sasong_en: "Direct-sow or start indoors from April - slow to germinate, harvest continuously Jun–Oct", svarighet: "latt" },
  selleri: { visningsnamn: "Selleri", vatten: "hog", sol: "sol", avstand_cm: 25,
    sasong: "Så inomhus feb–mars, plantera ut i juni, skörda sep–okt",
    sasong_en: "Sow indoors Feb–March, transplant in June, harvest Sep–Oct", svarighet: "svar" },
};
